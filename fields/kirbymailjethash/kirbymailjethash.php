...
class KirbyMailjetHashField extends BaseField
{
    public function input()
    {
        ...
        $color = isset($this->color) ? $this->color : '#888';
        $borderwidth = '2px';
        $borderstyle = 'solid';
        $borderradius = '0px';
        $bordercolor = isset($this->bordercolor) ? $this->bordercolor : '#ddd';
        $backgroundcolor = isset($this->backgroundcolor) ? $this->backgroundcolor : 'transparent';

        $reminder = new Brick('div', KirbyMailjet::hash());
